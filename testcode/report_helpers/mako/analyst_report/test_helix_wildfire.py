...
from priv_module_helpers.report_helpers.mako.analyst_report import helix_wildfire as target

class TestHelixPaloaltoReportModule(unittest.TestCase):
	"""test class of ReportMaker in helix_wildfire.py
	"""

	def setUp(self):
		testfile = _TESTDIR_+"/helix_wildfire.json"
