...
from priv_module_helpers.report_helpers.mako.analyst_report import helix_squid as target

class TestHelixSquidReportModule(unittest.TestCase):
	"""test class of ReportMaker in helix_squid.py
	"""
...
class TestHelixSquidEditorModule(unittest.TestCase):
	"""test class of ReportMaker in helix_squid.py
	"""
