...
from priv_module_helpers.report_helpers.mako.analyst_report import helix_paloalto as target

class TestHelixPaloaltoReportModule(unittest.TestCase):
	"""test class of ReportMaker in helix_paloalto.py
	"""

	def setUp(self):
		testfile = _TESTDIR_+"/helix_paloalto.json"
...
class TestHelixPaloaltoEditorModule(unittest.TestCase):
	"""test class of ReportMaker in helix_paloalto.py
	"""
