...
from priv_module_helpers.report_helpers.mako.analyst_report import fireeye_nx2 as target

class TestReportMaker(unittest.TestCase):
	"""test class of ReportMaker in fireeye_nx2.py
	"""

	def setUp(self):
		testfile = _TESTDIR_+"/fenx2nd_1.json"
		with open(testfile) as f:
			self.reportdata = json.load(f)
		testfile2 = _TESTDIR_+"/fenx2nd_2.json"
